      ...
      <div ref={shellRef} className="relative z-[1] group">
        <section
          ...
          style={{
            ...
            maxHeight: 'var(--card-max-height, none)',
            maxWidth: '100%',
            aspectRatio: '0.718',
            borderRadius: cardRadius,
            ...
            >
              ...
              {showUserInfo && (
                ...
                >
                  ...
                  <a
                    className="border border-white/10 rounded-lg px-4 py-3 text-xs font-semibold text-white/90 cursor-pointer backdrop-blur-[10px] transition-all duration-200 ease-out hover:border-white/40 hover:-translate-y-px no-underline flex items-center justify-center"
                    href="#contact"
